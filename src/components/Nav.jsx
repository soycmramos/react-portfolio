    ...
    <nav>
      ...
      <div className="fixed top-14 inset-0 p-4 w-3/5 sm:w-1/2 bg-white shadow-sm md:shadow-none md:w-auto md:static md:p-0 -translate-x-full md:translate-x-0 transition">
        <ul className="flex flex-col gap-2 md:flex-row">
          <li><a href="#" className="block w-full py-2 px-4 rounded hover:bg-slate-100 font-semibold transition">Item 1</a></li>
          <li><a href="#" className="block w-full py-2 px-4 rounded hover:bg-slate-100 font-semibold transition">Item 2</a></li>
          <li><a href="#" className="block w-full py-2 px-4 rounded hover:bg-slate-100 font-semibold transition">Item 3</a></li>
          <li><a href="#" className="block w-full py-2 px-4 rounded hover:bg-slate-100 font-semibold transition">Item 4</a></li>
        </ul>
      </div>
    </nav>
  )
